...
def diagnostics_snapshot():
    ...
    return {
        ...
        "configuration": {
            ...
            "pipeline_imgsz": DEFAULT_PIPELINE_IMGSZ,
            "pipeline_detection_interval": DEFAULT_PIPELINE_DETECTION_INTERVAL,
            "pipeline_confidence_threshold": DEFAULT_PIPELINE_CONFIDENCE_THRESHOLD,
            ...
            "pipeline_tracker_min_hits": DEFAULT_PIPELINE_TRACKER_MIN_HITS,
